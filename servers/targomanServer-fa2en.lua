...
local function tokenize(lines)
    ...
    for i = 1, #lines do
        local NormalizedLine = txtproc.tokenize(lines[i], 'fa', false)
...
local function postProcess(iString)
    iString = iString:gsub('۱', '1');
    iString = iString:gsub('۲', '2');
    iString = iString:gsub('۳', '3');
    iString = iString:gsub('۴', '4');
    iString = iString:gsub('۵', '5');
    iString = iString:gsub('۶', '6');
    iString = iString:gsub('۷', '7');
    iString = iString:gsub('۸', '8');
    iString = iString:gsub('۹', '9');
    iString = iString:gsub('۰', '0');
